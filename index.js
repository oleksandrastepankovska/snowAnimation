...
const drawSnowflakes = () => {
	for(let i=0; i < snowflakesNumber; i++){
		...
		gradient.addColorStop(0, "rgba(255, 255, 255," + snowflakesArray[i].opacity + ")");
		gradient.addColorStop(.8, "rgba(210, 236, 242," + snowflakesArray[i].opacity + ")");
		gradient.addColorStop(1, "rgba(237, 247, 249," + snowflakesArray[i].opacity + ")");
...
const moveSnowflakes = () => {
	for(var i=0; i < snowflakesNumber; i++){
		const snowflakesItem = snowflakesArray[i]
